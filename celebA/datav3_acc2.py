...
class FLAGS2(object):
    def __init__(self):
        ...
        self.test_samples = 32 # sample num for testing
...
#        mis_vec_list.append(mis_vec)
    ...
    for i in range(len(img_name_list)):
        ...
        #img_list.append(str(img_name_list[i]))
    # print(img_list)
...
#        Xb_name_list.append(test_list[i][0])
#        Xb_r_label_list.append(test_list[i][3])
#        Xb_rm_label_list.append(test_list[i][5])
#    Xb_name_list = np.array(Xb_name_list)
#    Xb_r_label_list = np.array(Xb_r_label_list)
#    Xb_rm_label_list = np.array(Xb_rm_label_list)
#    print(Xb_name_list.shape)
#    print(Xb_r_label_list.shape)
#    print(Xb_rm_label_list.shape)
#    np.save('test_acc2/Xb.npy', Xb_name_list)
#    np.save('test_acc2/Xa_label.npy', Xb_rm_label_list)
#    np.save('test_acc2/X_r_label.npy', Xb_r_label_list)
#    exit()
    #print(test_list[0][0])
    #exit()
