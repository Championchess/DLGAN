...
#        mis_vec_list.append(mis_vec)
    ...
    for i in range(telen):
        test_str = test_list[i][0].split('/')[-1]
        test_name_list.append(test_str)
        test_r_label.append(test_list[i][3])
        test_ans_label.append(test_list[i][5])
    
    test_name_list = np.array(test_name_list)
    test_r_label = np.array(test_r_label)
    test_ans_label = np.array(test_ans_label)
    print(test_name_list.shape, test_r_label.shape, test_ans_label.shape)
    np.save('Xa_vacant.npy', test_name_list)
    np.save('Xa_r_label_vacant.npy', test_r_label)
    np.save('Xa_ans_label_vacant.npy', test_ans_label)
...
#    tl.files.exists_or_mkdir("/raid/zhaoyihao/celebA/black")
#    tl.files.exists_or_mkdir("/raid/zhaoyihao/celebA/blond")
#    tl.files.exists_or_mkdir("/raid/zhaoyihao/celebA/brown")
#    tl.files.exists_or_mkdir("/raid/zhaoyihao/celebA/male")
#    tl.files.exists_or_mkdir("/raid/zhaoyihao/celebA/female")
#
#    sample_img = np.ones([1, 128, 128, 3], dtype=np.float32)
#    for i in test_list:
#        sample_img[0] = _map_fn(i[0])
#        img_p = i[0].split('/')[-1]
#        if (i[4][0:3]==[1,0,0]):
#            tl.visualize.save_images(sample_img, [1,1], "/raid/zhaoyihao/celebA/black/"+img_p)
#        if (i[4][0:3]==[0,1,0]):
#            tl.visualize.save_images(sample_img, [1,1], "/raid/zhaoyihao/celebA/blond/"+img_p)
#        if (i[4][0:3]==[0,0,1]):
#            tl.visualize.save_images(sample_img, [1,1], "/raid/zhaoyihao/celebA/brown/"+img_p)
#        if (i[4][3:5]==[1,0]):
#            tl.visualize.save_images(sample_img, [1,1], "/raid/zhaoyihao/celebA/male/"+img_p)
#        if (i[4][3:5]==[0,1]):
#            tl.visualize.save_images(sample_img, [1,1], "/raid/zhaoyihao/celebA/female/"+img_p)
#
#        """
#        if (i[4]==[1,0,0,1,0]):
#            tl.visualize.save_images(sample_img, [1,1], "/home/wuruihai/ILGAN/evaluation/celebA/black_male/"+img_p)
#        if (i[4]==[1,0,0,0,1]):
#            tl.visualize.save_images(sample_img, [1,1], "/home/wuruihai/ILGAN/evaluation/celebA/black_female/"+img_p)
#        if (i[4]==[0,1,0,1,0]):
#            tl.visualize.save_images(sample_img, [1,1], "/home/wuruihai/ILGAN/evaluation/celebA/blond_male/"+img_p)
#        if (i[4]==[0,1,0,0,1]):
#            tl.visualize.save_images(sample_img, [1,1], "/home/wuruihai/ILGAN/evaluation/celebA/blond_female/"+img_p)
#        if (i[4]==[0,0,1,1,0]):
#            tl.visualize.save_images(sample_img, [1,1], "/home/wuruihai/ILGAN/evaluation/celebA/brown_male/"+img_p)
#        if (i[4]==[0,0,1,0,1]):
#            tl.visualize.save_images(sample_img, [1,1], "/home/wuruihai/ILGAN/evaluation/celebA/brown_female/"+img_p)
#        """
#    print("finish test_list")
#    for i in train_list:
#        sample_img[0] = _map_fn(i[0])
#        img_p = i[0].split('/')[-1]
#        if (i[4][0:3]==[1,0,0]):
